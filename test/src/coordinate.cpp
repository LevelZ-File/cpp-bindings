...
int main() {
    ...
    // #from_string
    r |= assert(LevelZ::Coordinate2D::from_string("[1, 2]") == LevelZ::Coordinate2D(1, 2));
    r |= assert(LevelZ::Coordinate2D::from_string("[-2,4]") == LevelZ::Coordinate2D(-2,4));

    r |= assert(LevelZ::Coordinate3D::from_string("[1, 2, 3]") == LevelZ::Coordinate3D(1, 2, 3));
    r |= assert(LevelZ::Coordinate3D::from_string("[-2,4,5]") == LevelZ::Coordinate3D(-2,4,5));
